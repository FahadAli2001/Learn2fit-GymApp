        ...
        child: Padding(
          ...
          child: Column(
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    Obx(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              color: (MealAssesment.value == true)?Colors.green:null,
                              borderRadius: BorderRadius.circular(20)
                          ),
                          child: Center(
                              child: Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 12),
                                child: Text("Meal Assesment",
                                  style: TextStyle(
                                      color: (MealAssesment.value == true)?Colors.white:Colors.black,
                    ...
                    Obx(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            color: (TrainingAssesment.value == true)?Colors.green:null,
                            borderRadius: BorderRadius.circular(20),
                            //color: Colors.green
                          ),
                          child: Center(
                              child: Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 12),
                                child: Text("Training Assesment",
                                  style: TextStyle(
                                      color: (TrainingAssesment.value == true)?Colors.white:Colors.black,
                                      fontWeight: FontWeight.bold,
                                      fontSize: Get.width * 0.04
                                  ),),
                              )),
              ...
              (MealAssesment.value == true)?MealAssesmentScreen():TrainingAssesmentScreen()
            ],
          ),
        ),
      ),
